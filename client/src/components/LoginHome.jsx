        ...
        <>
            <div>
                ...
                <div className='flex justify-between items-center px-6 py-4'>
                    <div >
                        <p className="text-gray-600 font-normal text-3xl leading-14 tracking-tight  ">News/Blogs</p>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 gap-4 ">
                    <div>
                        <div class=" text-center p-4 flex">
                            <div class="w-3/5">
                                <p className=' text-2xl leading-14 tracking-tight mt-5 text-[#000000]'>
                    ...
                    <div class=" text-center p-4">
                        ...
                        <div className="bg-gradient-to-b from-white via-[#FFF5E3] to-[#FFEDCC] ">
                            <div className=" text-left p-4 flex relative">
                                ...
                                <div>
                                    <img src={events1} className=" flex justify-center items-center  " width="250px"/>
                                </div>
                    ...
                    <div class=" text-center p-4">
                        <div className=" ">
                            <div className=" text-left p-4 flex relative">
                                ...
                                <div>
                                    <img src={flat} className=" flex justify-center items-center absolute bottom-2 right-3 " width="250px"/>
                                </div>
